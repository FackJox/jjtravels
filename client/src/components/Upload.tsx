import React, { useEffect, useState, FormEvent, FormEventHandler } from 'react';
...
const Upload = () => {
  ...
  const onSelectPhoto: FormEventHandler<HTMLFormElement> = (e: FormEvent<HTMLFormElement>) => {
 ...
 const submitPhoto: FormEventHandler<HTMLFormElement> = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
