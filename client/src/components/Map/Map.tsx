...
const Map = () => {
  const filteredCountries = routeData.features.filter(
    (route: RouteProps) => route.properties.Country === "Spain"
  );
  ...
  return (
    <div>
      <MapContainer
        ...
        style={{ height: "100vh", width: "100wh", zIndex: "10" }}
      >
        <TileLayer
        ...
        {filteredCountries.map((route: RouteProps) => (
          <Marker
